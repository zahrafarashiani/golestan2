            ...
            <div id="layoutDefault_content">
                <main>
                    <nav class="navbar navbar-marketing navbar-expand-lg bg-white navbar-light">
                        <div class="container">
                            <a class="navbar-brand text-dark" href="index.php">bdok</a><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigationl"><img src="img/menu.png" style="height:20px;width:25px"/><i data-feather="menu"></i></button>
                    ...
                    <section class="bg-white py-10">
                        ...
                        <hr />
                        <?php
                            $sql4 = "SELECT * FROM post WHERE post_status = :status ORDER BY post_views DESC LIMIT 0, 1";
                        ...
                        ?>
                            ...
                            <div class="row">
                                <?php
                                    $sql = "SELECT * FROM post WHERE post_status = :status ORDER BY post_id DESC LIMIT 0, 6";
                            ...
                            <div class="row">
                                <?php
                                    $sql2 = "SELECT * FROM post WHERE post_status = :status ORDER BY post_views DESC LIMIT 0, 3";
                                    ...
                                    while($categories = $stmt->fetch(PDO::FETCH_ASSOC)){
                                        ...
                                        <div class="col-lg-4 col-md-6 mb-5">
                                            <a class="card card-link border-top border-top-lg border-primary h-100 lift" href="categories.php?category_id=<?php echo $category_id ?>&category_name=<?php echo $category_title ?>"
                                                ...
                                                <div class="card-footer bg-transparent pt-0 pb-5"><div class="badge badge-pill badge-light font-weight-normal px-3 py-2"><?php echo $total_posts ?></div></div></a>
                                        </div>
                                    <?php }
                                 ?>
                            </div>
